...
if [[ $# -lt 1 ]] || [[ $# -gt 2 ]]; then
    echo "Usage: $0 <cert_names> [private key password]"
    exit 1
fi

# Generate a new private key
echo "Generating Template.."
cp maat-cert-template.cfg $1.cfg
echo "cn=\"$1\"" >> $1.cfg
...
certtool --generate-certificate --load-privkey $1.key \
	 --outfile $1.pem --template $1.cfg --load-ca-certificate ca.pem \
