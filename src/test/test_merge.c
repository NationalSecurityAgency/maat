...
START_TEST(test_merge)
{
    ...
    /* Cast is justified because this function does not regard signedness */
    ret_val = maat_read_sz_buf(o_pipe[0], (unsigned char **)&res, &buf_sz, &transferred, &eof_enc, TIMEOUT, 0);
