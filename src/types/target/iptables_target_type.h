 ...
 *
 */
#ifndef __IPTABLES_TYPE_H__
#define __IPTABLES_TYPE_H__
 ...
 */
#define IPTABLES_NAME	"iptables"

/**
 * iptables target_type universally unique 'magic' id number
 */
#define IPTABLES_MAGIC	(0x43211234)

void *iptables_read_instance(target_type *type, address *a, size_t *size);

/**
 * name for iptables target_type
 */
extern struct target_type iptables_target_type;
